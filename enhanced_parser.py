"""
MathScript Compiler - Part 2
Enhanced Parser with Semantic Analysis and Intermediate Code Generation
Integrates with existing lexer.py
"""
...
class SymbolType :
    """Represents data types in MathScript"""
    INTEGER ="INTEGER"
    FLOAT ="FLOAT"
    UNKNOWN ="UNKNOWN"
...
class SymbolTable :
    ...
    def print_table (self ):
        """Print symbol table in readable format"""
        print ("\n"+"="*60 )
        print ("SYMBOL TABLE")
        print ("="*60 )
...
class EnhancedParser :
    """Enhanced parser with parse tree, semantic analysis, and TAC generation"""
    ...
    def parse (self )->Tuple [ParseTreeNode ,List [str ]]:
        """Parse the input and return a PROGRAM parse tree and intermediate code"""
    ...
    def get_parse_tree (self )->Optional [ParseTreeNode ]:
        """Return the already-built parse tree (or None if parse() not called)"""
